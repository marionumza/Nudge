...
CSV_COLUMNS = ['mouse_activity', 'keyboard_activity', 'time_last_request', 'foreground_app']
...
INPUT_COLUMNS = [
    ...
    tf.feature_column.numeric_column('mouse_activity'),
    tf.feature_column.numeric_column('keyboard_activity'),
    tf.feature_column.numeric_column('time_last_request'),

    tf.feature_column.categorical_column_with_hash_bucket(
        'foreground_app', hash_bucket_size=1000, dtype=tf.string),
]
...
def build_estimator(config, embedding_size=8, hidden_units=None):
  ...
  """
  (mouse_activity, keyboard_activity, time_last_request, foreground_app) = INPUT_COLUMNS
  """Build an estimator."""
