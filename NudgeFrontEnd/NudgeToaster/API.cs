...
namespace NudgeToaster
{
    class API
    {
        ...
        /// </summary>
        const string clientID = "660754421861-a35av9ehgd75263sn9vhnjol6dmmfl0f.apps.googleusercontent.com";
        ...
        public void authGoogleCloud()
        {
            ...
            string authorizationRequest = string.Format("{0}?response_type=code&scope=https%3A%2F%2Fwww.googleapis.com%2Fauth%2Fcloud-platform&redirect_uri={1}&client_id={2}&state={3}&code_challenge={4}&code_challenge_method={5}",
        ...
        /// </summary>
        /// <param name="e"></param>
        public void ProcessAuth(NavigationEventArgs e)
        {
